        ...
        <div className="max-w-7xl mx-auto px-6 w-full py-20 md:py-32 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            ...
            <div className="flex items-center gap-4 mb-8">
              <a href="https://facebook.com" target="_blank" rel="noreferrer" className="w-11 h-11 rounded-full bg-zinc-800/80 hover:bg-primary border border-white/5 hover:border-primary flex items-center justify-center text-white transition-all hover:-translate-y-1" aria-label="Facebook">
                <FacebookIcon className="w-5 h-5" />
              </a>
              <a href="https://zalo.me" target="_blank" rel="noreferrer" className="w-11 h-11 rounded-full bg-zinc-800/80 hover:bg-primary border border-white/5 hover:border-primary flex items-center justify-center text-white transition-all hover:-translate-y-1" aria-label="Zalo">
                <MessageSquare className="w-5 h-5" />
              </a>
              <a href="https://youtube.com" target="_blank" rel="noreferrer" className="w-11 h-11 rounded-full bg-zinc-800/80 hover:bg-primary border border-white/5 hover:border-primary flex items-center justify-center text-white transition-all hover:-translate-y-1" aria-label="Youtube">
                <YoutubeIcon className="w-5 h-5" />
              </a>
              <a href="tel:0987654321" className="w-11 h-11 rounded-full bg-zinc-800/80 hover:bg-primary border border-white/5 hover:border-primary flex items-center justify-center text-white transition-all hover:-translate-y-1" aria-label="Call Truong Nguyen">
